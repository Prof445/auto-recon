...
Auto-Recon is a comprehensive, modular reconnaissance tool that automates the entire web application reconnaissance process. It collects subdomains, resolves IPs, discovers URLs, performs directory fuzzing, probes ports, and **generates a professional interactive HTML report**.
