...
Auto-Recon is a comprehensive, modular reconnaissance tool that automates the entire web application reconnaissance process. It collects subdomains, resolves IPs, discovers URLs, potential attack endpoints, performs directory fuzzing, probes ports, and **generates a professional interactive HTML report**.
...
Reload your shell config and verify all tools are working <sub>(Below Command is for Kali-Linux, use ```source ~/.bashrc``` for other Linux)</sub>
```bash
...
[![Watch demo here](https://i.ibb.co/xKsgGBy8/Screenshot-2025-10-07-025246.png)](https://vimeo.com/1124984891?share=copy)
